...
<body>
    ...
    var klunkerkranich = L.marker([]).addTo(map);
    ...
    var czarHagestolz = L.marker([]).addTo(map);
    ...
    var elseClub = L.marker([]).addTo(map);
    ...
    var incognito = L.marker([]).addTo(map);
    ...
    var clandestine = L.marker([]).addTo(map);
